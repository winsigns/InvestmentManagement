...
public class ECACashPoolService {
    ...
    public Collection<ECACashPool> findByFundIdAndExternalCapitalAccountId(Long fundId, Long externalCapitalAccountId) {
    ...
    public ECACashPool addECACashPool(CreateCashPoolCommand createCashPoolCommand) {
        ECACashPool eCACashPool = ecaCashPoolRepository.findByFundIdAndExternalCapitalAccountIdAndCurrency(
    ...
    public ECACashPool transferTo(Long ecaCashPoolId, TransferAccountCommand transferAccountCommand) {
        ...
        ecaCashPool
                .setUnassignedCapital(ecaCashPool.getUnassignedCapital() + transferAccountCommand.getChangedCapital());
        return ecaCashPoolRepository.save(ecaCashPool);
    }

    public ECACashPool transferFrom(Long ecaCashPoolId, TransferAccountCommand transferAccountCommand) {
    ...
    @Transactional
    public Collection<ECACashPool> allot(Long dstEcaCashPoolId, Long srcEcaCashPoolId, Double changedCapital) {
        ...
        dstEcaCashPool.setUnassignedCapital(dstEcaCashPool.getUnassignedCapital() + Math.abs(changedCapital));
        ...
        if (srcEcaCashPool == null)
            return null;
        srcEcaCashPool.setUnassignedCapital(srcEcaCashPool.getUnassignedCapital() - Math.abs(changedCapital));
