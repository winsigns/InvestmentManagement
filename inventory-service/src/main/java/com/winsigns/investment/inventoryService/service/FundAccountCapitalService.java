...
public class FundAccountCapitalService {
    ...
    public FundAccountCapital addFundAccountCapital(CreateFundAccountCapitalCommand createFundAccountCapitalCommand) {
        FundAccountCapital fundAccountCapital = fundAccountCapitalRepository
                .findByFundAccountIdAndExternalCapitalAccountTypeAndCurrency(
        ...
        if (fundAccountCapital == null) {
            ...
            fundAccountCapital
                    .setExternalCapitalAccountType(createFundAccountCapitalCommand.getExternalCapitalAccountType());
