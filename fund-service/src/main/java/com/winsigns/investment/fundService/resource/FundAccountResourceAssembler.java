...
public class FundAccountResourceAssembler extends ResourceAssemblerSupport<FundAccount, FundAccountResource> {
    ...
    public FundAccountResource toResource(FundAccount fundAccount) {
        ...
        FundAccountResource fundAccountResource = createResourceWithId(fundAccount.getId(), fundAccount);
        ...
        fundAccountResource.add(linkTo(methodOn(FundController.class).readPortfolios(fundId, fundAccount.getId()))
