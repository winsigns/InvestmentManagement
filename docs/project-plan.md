...
然后按全部交易服务的数量，以及平均估计，这些交易服务开发完成大约需要150人天。
...
具体事务服务按平均5人天（包含设计）计算，全部完成需要50人天。
...
选型完成之后的第一步目标是完成现在定义的11张报表。

根据之前指标开发的经验，这里给出大致60人天的工作量预估。

##### Web前端开发

前端开发需要后端的接口配合。最基础的时间是跟后台一起完成。前台开发可能会有一些额外的开发工作，比如之前遇到的复制粘贴技术问题等等。需要额外预留出工作量。这些工作在没有看到页面需求的时候难以预估。前端开发的工作量待定。
...
| 第1阶段 | 前端基本界面开发   |          | 15            |        |
| 第2阶段 | 交易服务完善     |          | 30            |        |
| 第2阶段 | 更多交易服务开发   | 交易服务完善   | 150           |  是     |
| 第2阶段 | 更多资金持仓服务开发 |          | 60            |  是     |
| 第2阶段 | 行情服务       |          | 60            |        |
| 第2阶段 | 报盘服务       |          | 40            |        |
| 第2阶段 | 产品管理服务     |          | 80            |  是     |
| 第2阶段 | 权限认证服务     |          | 30+30(相关模块修改) |        |
| 第2阶段 | 风控服务       |          | 40            |        |
| 第2阶段 | 风控脚本       |          | 10            |  是     |
| 第2阶段 | 事务服务核心开发   |          | 15            |        |
| 第2阶段 | 事务服务开发     | 事务服务核心开发 | 50            |  是     |
| 第2阶段 | 数据分析、报表服务  |          | 60            |       |
| 第2阶段 | Web前端开发    | 全部后端服务   | 200           |  是     |
| 并行任务 | 开发环境搭建     |          | 10            |       |
| 并行任务 | 持续集成流程实施   |          | 15            |        |
