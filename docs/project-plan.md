...
权限认证服务本身大致估计的工作量是详细设计10人天，开发30人天。其他服务的跟随修改视当时的开发规模而定。暂定是30人天。
...
根据之前指标开发的经验，选型大致5人天，详细设计15人天，框架开发30人天。11张报表每张平均理解需求1人天，详细设计1人天，开发3人天。一共需要105人天。
...
| 并行任务       | 开发环境搭建           |          | 10            |       |
| 并行任务       | 持续集成流程实施         |          | 15            |       |
| 预留工作量      | 单元测试 (1185×0.2)  |          | 237           |       |
| 预留工作量      | bug修复 (1185×0.2) |          | 237           |       |
| 预留工作量      | 其他情况 (1185×0.1)  |          | 118.5         |       |
| **总    计** |                  |          | 1777.5        |       |
